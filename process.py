...
def plot(ti):
    ...
    ax_fig[0].set_xlim(-60,60)
    ax_fig[0].set_ylim(-60,60)
    ax_fig[1].set_xlim(-60,60)
    ax_fig[1].set_ylim(-60,60)
    ax_fig[2].set_xlim(-60,60)
    ax_fig[2].set_ylim(-60,60)
    ax_fig[3].set_xlim(-60,60)
    ax_fig[3].set_ylim(-60,60)
    ax_fig[4].set_xlim(-60,60)
    ax_fig[4].set_ylim(-60,60)
    ax_fig[5].set_xlim(-60,60)
    ax_fig[5].set_ylim(-60,60)
    fig.tight_layout()
