...
def plot(ti):
    ...
    ax_fig[1].set_title("Polaritonic field",fontsize=17)
    ...
    ax_fig[0].set_xlim(-20,20)
    ax_fig[0].set_ylim(-20,20)
    ax_fig[1].set_xlim(-20,20)
    ax_fig[1].set_ylim(-20,20)
    ax_fig[3].set_xlim(-20,20)
    ax_fig[3].set_ylim(-20,20)
    ax_fig[4].set_xlim(-20,20)
    ax_fig[4].set_ylim(-20,20)
